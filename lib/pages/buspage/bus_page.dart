...
class BusSearchPageState extends State<BusSearchPage> {
  ...
  void _shapeDataWidget(String busdata) async {
    ...
    prefs.setString("busdata", busStationDetalEntity.toString());
  ...
  void getData() async {
    ...
    if (data != null) {
      ...
      ProviderUtils.Pro<BusProvider>(context).setBusStationDetal(new BusStationDetalEntity.fromJson(responseJson));
    }
  }
}
